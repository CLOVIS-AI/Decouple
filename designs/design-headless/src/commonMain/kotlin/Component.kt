...
interface Component {
	...
	interface Meta<C : Component> {
		 ...
		 *
		 * Components created as part of the Decouple project (declared as an interface in `components`)
		 * should be named after their interface and their function name.
		 *
		 * For example, the component [PrimaryButton][Buttons.ButtonSpec] declared in the [Buttons] interface should
